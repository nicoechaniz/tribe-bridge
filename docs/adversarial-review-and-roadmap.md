...
| High | Codex and CompAII share a GitHub account, so GitHub attribution is not agent attribution; comments can be edited/deleted. | Explicitly documented limitation. Next control is separate GitHub App principals, detached signatures, and external hash anchoring. |
